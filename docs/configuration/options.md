...
| KEYCLOAK_AUTH_URL               | URL of the Keycloak server (should end with `/auth`).                                                                                                                                      | `http://localhost:38086/auth` |
...
| NOTIFY_MAILER_LINKTEMPLATE | Template used to generate a clickable link in the notification emails. `[list_id]` is mandatory and is replaced with the lists internal id.⁴ | `http://localhost:38080/recommendations/[list_id]` |
