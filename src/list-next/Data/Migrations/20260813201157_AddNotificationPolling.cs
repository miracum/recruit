    ...
    public partial class AddNotificationPolling : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .OldAnnotation("Npgsql:Enum:trial_permission_level", "coordinator,trial_admin,viewer");
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "trial_identifier_system", "trial_identifier_value", "email", "channel" },
                unique: true);
        }
