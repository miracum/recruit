...
| kubectl.image.repository | string | `"alpine/k8s"` |  |
| kubectl.image.tag | string | `"1.34.9@sha256:72c921a10c53ab749674e828ad12b776d006481c852bba7dd89e149ceed666f3"` |  |
...
| listNext.terminationGracePeriodSeconds | int | `30` | seconds the kubelet waits after starting pod termination (preStop hook + SIGTERM) before force-killing the container. Must comfortably exceed `lifecycle.preStop.sleep.seconds` below, plus however long the app itself takes to finish in-flight requests after SIGTERM. |
